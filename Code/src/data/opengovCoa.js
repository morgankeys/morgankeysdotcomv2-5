...
export const opengovCoa = {
  ...
  sections: [
    ...
    },
    {
      ...
      paragraphs: [
        'Local governments upload large amounts of data to OpenGov on a quarterly or monthly basis and then use the platform to share interactive reports both internally and publicly, with the citizens they serve.',
        'Due to the complexity of financial data, the usefulness and accuracy of these reports are heavily dependent on the way data is categorized. Sophisticated categorization schemes are created in enterprise resource planning systems and must be mirrored in OpenGov.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'A small government might use three taxonomies, each with 2-3 levels. But more sophisticated governments could have 4-5 taxonomies, with up to six levels. We often saw charts that tracked tens of thousands of types.',
      ],
      image: {
    ...
    },
    {
      ...
      paragraphs: [
        'OpenGov already had an existing tool for managing charts of accounts, built as an MVP in the early days of the startup.',
        'The tool made certain implementation assumptions that meant these taxonomies had to be handled separately. It also used a folder-like interface that did not actually represent the data well and, due to a lack of error-handling, even allowed users to make nonsensical edits and corrupt their data accidentally.',
    ...
    },
    {
      ...
      paragraphs: [
        ...
        'Luckily, we had retired finance directors on staff with decades of experience. We also had a team of technical support staff who were talking with customers on a daily basis, training them and solving technical challenges. I set up learning sessions and made countless desk-visits.',
    ...
    },
    {
      ...
      paragraphs: [
        'Given the complexity of this tool and the data it was managing, I had to really grapple with the subject matter. I began diagramming concepts, at first just to help articulate ideas to myself.',
        'I shared these diagrams with the customer success teams for feedback. It prompted great discussions, but we also realized that these documents could be training tools. After all, I was not the only team member struggling to learn these concepts.',
    ...
    },
    {
      ...
      paragraphs: [
        'Imagining a dynamic spreadsheet, with columns automatically scrolling to show relationships, I mocked up the new concept. It was a difficult concept to communicate abstractly so I tried various methods to explain it. I tried Framer, animations, and even simple html/css prototypes. The concept became known as the “slot-machine” in reference to the way it synchronized.',
    ...
    },
    {
      ...
      paragraphs: [
        'I travelled with OpenGov account managers to visit local customers and test with live customers. I used a short pre-interview script and ran a standard task-based usability test. The goal was to assess if users could understand what the interface was communicating and if they could successfully perform basic editing and navigation tasks.',
    ...
    },
    {
      ...
      heading: 'Impact',
      paragraphs: [
        'The new design replaced the old editor and became the workhorse of the OpenGov platform. It enabled Customer Success to efficiently support customers and make chart of accounts manipulation accessible to more end-users.',
