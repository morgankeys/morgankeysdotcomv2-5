// Verbatim copy transcribed from morgankeys.com.
// Case studies are the featured, prominent projects with a "View case study" link.

export const caseStudies = [
  {
    id: 'boardable-public-sites',
    title: 'Boardable Public Sites',
    company: 'Boardable',
    year: '2025',
    accent: '#f25325',
    description:
